...
/***/ function(module, exports) {
	...
	var _greyepoxy$elm_gamehostserver$Client_Async_Requests$gameInfo = _elm_lang$core$Json_Decode$string;
	var _greyepoxy$elm_gamehostserver$Client_Async_Requests$getGameInformation = F2(
		function (userId, gameId) {
			return A2(
				_evancz$elm_http$Http$get,
				_greyepoxy$elm_gamehostserver$Client_Async_Requests$gameInfo,
				_greyepoxy$elm_gamehostserver$Shared_Async_Requests$render(
					_greyepoxy$elm_gamehostserver$Shared_Async_Requests$AsyncClientR(
						_greyepoxy$elm_gamehostserver$Shared_Async_Requests$GetUserGameR(
							{ctor: '_Tuple2', _0: userId, _1: gameId}))));
		});

	var _greyepoxy$elm_gamehostserver$Shared_Messages$NewServerMsg = function (a) {
		return {ctor: 'NewServerMsg', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$Shared_Messages$NoOp = {ctor: 'NoOp'};

	var _greyepoxy$elm_gamehostserver$Shared_Async_Functions$AsyncFunctions = function (a) {
		return {getWhatServerSays: a};
	};

	var _greyepoxy$elm_gamehostserver$Client_Async_Functions$mapServerResponseToMsg = function (response) {
		return _greyepoxy$elm_gamehostserver$Shared_Messages$NewServerMsg(response);
	};
	var _greyepoxy$elm_gamehostserver$Client_Async_Functions$mapHttpErrorToMsg = function (httpErr) {
		var _p0 = httpErr;
		switch (_p0.ctor) {
			case 'Timeout':
				return _greyepoxy$elm_gamehostserver$Shared_Messages$NewServerMsg('Timeout');
			case 'NetworkError':
				return _greyepoxy$elm_gamehostserver$Shared_Messages$NewServerMsg('NetworkError');
			case 'UnexpectedPayload':
				return _greyepoxy$elm_gamehostserver$Shared_Messages$NewServerMsg(
					A2(_elm_lang$core$Basics_ops['++'], 'UnexpectedPayload:', _p0._0));
			default:
				return _greyepoxy$elm_gamehostserver$Shared_Messages$NewServerMsg(
					A2(_elm_lang$core$Basics_ops['++'], 'BadResponse:', _p0._1));
		}
	};
	var _greyepoxy$elm_gamehostserver$Client_Async_Functions$getWhatServerSays = A3(
		_elm_lang$core$Task$perform,
		_greyepoxy$elm_gamehostserver$Client_Async_Functions$mapHttpErrorToMsg,
		_greyepoxy$elm_gamehostserver$Client_Async_Functions$mapServerResponseToMsg,
		A2(_greyepoxy$elm_gamehostserver$Client_Async_Requests$getGameInformation, 5, 10));
	var _greyepoxy$elm_gamehostserver$Client_Async_Functions$clientAsyncFunctions = {getWhatServerSays: _greyepoxy$elm_gamehostserver$Client_Async_Functions$getWhatServerSays};

	var _greyepoxy$elm_gamehostserver$Shared_Model$initialModel = {clientMsg: 'Hello!', serverMsg: _elm_lang$core$Maybe$Nothing};
	var _greyepoxy$elm_gamehostserver$Shared_Model$AppModel = F2(
		function (a, b) {
			return {clientMsg: a, serverMsg: b};
		});

	var _greyepoxy$elm_gamehostserver$Shared_Update$updateWithFuncs = F3(
		function (funcs, msg, model) {
			var _p0 = msg;
			if (_p0.ctor === 'NoOp') {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							serverMsg: _elm_lang$core$Maybe$Just(_p0._0)
						}),
	...
	var _greyepoxy$elm_gamehostserver$Shared_View$view = function (model) {
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(_elm_lang$core$Basics_ops['++'], 'Client says: ', model.clientMsg))
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'Server says: ',
								_elm_lang$core$Basics$toString(model.serverMsg)))
						]))
				]));
	};

	var _greyepoxy$elm_gamehostserver$ClientMain$init = {ctor: '_Tuple2', _0: _greyepoxy$elm_gamehostserver$Shared_Model$initialModel, _1: _greyepoxy$elm_gamehostserver$Client_Async_Functions$clientAsyncFunctions.getWhatServerSays};
	var _greyepoxy$elm_gamehostserver$ClientMain$main = {
		main: _elm_lang$html$Html_App$program(
			{
				init: _greyepoxy$elm_gamehostserver$ClientMain$init,
				subscriptions: function (_p0) {
					return _elm_lang$core$Platform_Sub$none;
				},
				update: _greyepoxy$elm_gamehostserver$Shared_Update$updateWithFuncs(_greyepoxy$elm_gamehostserver$Client_Async_Functions$clientAsyncFunctions),
				view: _greyepoxy$elm_gamehostserver$Shared_View$view
			})
	};

	var Elm = {};
	Elm['ClientMain'] = Elm['ClientMain'] || {};
	_elm_lang$core$Native_Platform.addPublicModule(Elm['ClientMain'], 'ClientMain', typeof _greyepoxy$elm_gamehostserver$ClientMain$main === 'undefined' ? null : _greyepoxy$elm_gamehostserver$ClientMain$main);
