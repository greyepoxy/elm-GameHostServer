...
/***/ function(module, exports) {
	...
	var _greyepoxy$elm_gamehostserver$Http_Response_Write$writeNode = function (node) {
		return _greyepoxy$elm_gamehostserver$Native_Http_Response_Write.toHtml(node);
	};

	var _greyepoxy$elm_gamehostserver$Server_Assets$AllAssetPaths = function (a) {
		return {main: a};
	};
	var _greyepoxy$elm_gamehostserver$Server_Assets$IndexAssetPaths = F2(
		function (a, b) {
			return {js: a, css: b};
		});

	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$GetUserGameR = function (a) {
		return {ctor: 'GetUserGameR', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$getUserGameR = A2(
		_Bogdanp$elm_route$Route_ops[':='],
		_greyepoxy$elm_gamehostserver$Shared_Async_Requests$GetUserGameR,
		A2(
			_Bogdanp$elm_route$Route_ops['</>'],
			A2(_Bogdanp$elm_route$Route_ops['<//>'], 'user', _Bogdanp$elm_route$Route$int),
			A2(_Bogdanp$elm_route$Route_ops['<//>'], 'game', _Bogdanp$elm_route$Route$int)));
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$rootApiPaths = _Bogdanp$elm_route$Route$router(
		_elm_lang$core$Native_List.fromArray(
			[_greyepoxy$elm_gamehostserver$Shared_Async_Requests$getUserGameR]));
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$renderRoot = function (r) {
		var _p0 = r;
		return A2(
	...
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$AsyncClientR = function (a) {
		return {ctor: 'AsyncClientR', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$asyncClientR = A2(
		_Bogdanp$elm_route$Route_ops['<//>'],
		'async',
		A2(_Bogdanp$elm_route$Route$child, _greyepoxy$elm_gamehostserver$Shared_Async_Requests$AsyncClientR, _greyepoxy$elm_gamehostserver$Shared_Async_Requests$rootApiPaths));
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$apiPaths = _Bogdanp$elm_route$Route$router(
		_elm_lang$core$Native_List.fromArray(
			[_greyepoxy$elm_gamehostserver$Shared_Async_Requests$asyncClientR]));
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$match = _Bogdanp$elm_route$Route$match(_greyepoxy$elm_gamehostserver$Shared_Async_Requests$apiPaths);
	var _greyepoxy$elm_gamehostserver$Shared_Async_Requests$render = function (r) {
		var _p1 = r;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
			_greyepoxy$elm_gamehostserver$Shared_Async_Requests$renderRoot(_p1._0));
	};

	var _greyepoxy$elm_gamehostserver$Server_Requests$RequestData = F3(
		function (a, b, c) {
			return {method: a, path: b, body: c};
		});

	var _greyepoxy$elm_gamehostserver$Server_Async_ClientRequests$getGameInfo = function (_p0) {
		var _p1 = _p0;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'\"',
	...
	var _greyepoxy$elm_gamehostserver$Server_Async_ClientRequests$handleRequest = F2(
		function (path, req) {
			var _p2 = path;
			return _elm_lang$core$Maybe$Just(
				_greyepoxy$elm_gamehostserver$Server_Async_ClientRequests$getGameInfo(_p2._0._0));
		});

	var _greyepoxy$elm_gamehostserver$Server_Pages_Index$meta = F2(
		function (attributes, childNodes) {
			return A3(_elm_lang$html$Html$node, 'meta', attributes, childNodes);
		});
	var _greyepoxy$elm_gamehostserver$Server_Pages_Index$getHtml = function (assetPaths) {
		return A3(
			_elm_lang$html$Html$node,
			'html',
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$lang('en-us')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_greyepoxy$elm_gamehostserver$Server_Pages_Index$meta,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$charset('utf-8')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Attributes$content('width=device-width, initial-scale=1')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$name('description'),
									_elm_lang$html$Html_Attributes$content('Chess in the browser')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$name('author'),
									_elm_lang$html$Html_Attributes$content('greyepoxy')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A3(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$href(assetPaths.css),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$src(assetPaths.js)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]))
	...
	var _greyepoxy$elm_gamehostserver$Server_Response$ResponseData = F3(
		function (a, b, c) {
			return {status: a, body: b, mimeType: c};
		});

	var _greyepoxy$elm_gamehostserver$Server_Routes$AsyncClientR = function (a) {
		return {ctor: 'AsyncClientR', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$Server_Routes$HomeR = function (a) {
		return {ctor: 'HomeR', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$Server_Routes$homeR = A2(
		_Bogdanp$elm_route$Route_ops[':='],
		_greyepoxy$elm_gamehostserver$Server_Routes$HomeR,
		_Bogdanp$elm_route$Route$static(''));
	var _greyepoxy$elm_gamehostserver$Server_Routes$sitemap = _Bogdanp$elm_route$Route$router(
		_elm_lang$core$Native_List.fromArray(
			[
				_greyepoxy$elm_gamehostserver$Server_Routes$homeR,
				A2(_Bogdanp$elm_route$Route$child, _greyepoxy$elm_gamehostserver$Server_Routes$AsyncClientR, _greyepoxy$elm_gamehostserver$Shared_Async_Requests$apiPaths)
			]));
	var _greyepoxy$elm_gamehostserver$Server_Routes$match = _Bogdanp$elm_route$Route$match(_greyepoxy$elm_gamehostserver$Server_Routes$sitemap);
	var _greyepoxy$elm_gamehostserver$Server_Routes$render = function (r) {
		var _p0 = r;
		if (_p0.ctor === 'HomeR') {
			return A2(
				_Bogdanp$elm_route$Route$reverse,
			...
			return _greyepoxy$elm_gamehostserver$Shared_Async_Requests$render(_p0._0);
		}
	};

	var _greyepoxy$elm_gamehostserver$Server_Responses$get404 = {status: 404, body: 'Page not found for request', mimeType: 'html'};
	var _greyepoxy$elm_gamehostserver$Server_Responses$getResponseForRequest = F2(
		function (assets, request) {
			var _p0 = _greyepoxy$elm_gamehostserver$Server_Routes$match(request.path);
			if (_p0.ctor === 'Just') {
				var _p1 = _p0._0;
				if (_p1.ctor === 'HomeR') {
					return {
						status: 200,
						body: _greyepoxy$elm_gamehostserver$Http_Response_Write$writeNode(
							_greyepoxy$elm_gamehostserver$Server_Pages_Index$getHtml(assets.main)),
						mimeType: 'html'
					};
				} else {
					var response = A2(_greyepoxy$elm_gamehostserver$Server_Async_ClientRequests$handleRequest, _p1._0, request);
					var _p2 = response;
					if (_p2.ctor === 'Just') {
						return {status: 200, body: _p2._0, mimeType: 'json'};
					} else {
						return _greyepoxy$elm_gamehostserver$Server_Responses$get404;
					}
				}
			} else {
				return _greyepoxy$elm_gamehostserver$Server_Responses$get404;
	...
	var _greyepoxy$elm_gamehostserver$ServerMain$responses = _elm_lang$core$Native_Platform.outgoingPort(
		'responses',
		function (v) {
			return {status: v.status, body: v.body, mimeType: v.mimeType};
		});
	var _greyepoxy$elm_gamehostserver$ServerMain$requests = _elm_lang$core$Native_Platform.incomingPort(
		'requests',
		A2(
	...
	var _greyepoxy$elm_gamehostserver$ServerMain$Flags = function (a) {
		return {assetPaths: a};
	};
	var _greyepoxy$elm_gamehostserver$ServerMain$Model = F2(
		function (a, b) {
			return {requestToResponedTo: a, assetPaths: b};
		});
	var _greyepoxy$elm_gamehostserver$ServerMain$ResponseReady = function (a) {
		return {ctor: 'ResponseReady', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$ServerMain$getResponseFromRequest = F2(
		function (assetPaths, requestToResponedTo) {
			return A3(
				_elm_lang$core$Task$perform,
				function (_p0) {
					return _greyepoxy$elm_gamehostserver$ServerMain$ResponseReady(_greyepoxy$elm_gamehostserver$Server_Responses$get404);
				},
				function (response) {
					return _greyepoxy$elm_gamehostserver$ServerMain$ResponseReady(response);
				},
				_elm_lang$core$Task$succeed(
					A2(_greyepoxy$elm_gamehostserver$Server_Responses$getResponseForRequest, assetPaths, requestToResponedTo)));
		});
	var _greyepoxy$elm_gamehostserver$ServerMain$update = F2(
		function (msg, model) {
			var _p1 = msg;
			if (_p1.ctor === 'Start') {
				var _p2 = _p1._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							requestToResponedTo: _elm_lang$core$Maybe$Just(_p2)
						}),
					_1: A2(_greyepoxy$elm_gamehostserver$ServerMain$getResponseFromRequest, model.assetPaths, _p2)
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _greyepoxy$elm_gamehostserver$ServerMain$responses(_p1._0)
				};
			}
		});
	var _greyepoxy$elm_gamehostserver$ServerMain$Start = function (a) {
		return {ctor: 'Start', _0: a};
	};
	var _greyepoxy$elm_gamehostserver$ServerMain$subscriptions = function (model) {
		var _p3 = model.requestToResponedTo;
		if (_p3.ctor === 'Just') {
			return _elm_lang$core$Platform_Sub$none;
		} else {
			return _greyepoxy$elm_gamehostserver$ServerMain$requests(_greyepoxy$elm_gamehostserver$ServerMain$Start);
		}
	};
	var _greyepoxy$elm_gamehostserver$ServerMain$main = {
		main: _elm_lang$html$Html_App$programWithFlags(
			{
				init: function (flags) {
					return {
						ctor: '_Tuple2',
						_0: {requestToResponedTo: _elm_lang$core$Maybe$Nothing, assetPaths: flags.assetPaths},
						_1: _elm_lang$core$Platform_Cmd$none
					};
				},
				update: _greyepoxy$elm_gamehostserver$ServerMain$update,
				subscriptions: _greyepoxy$elm_gamehostserver$ServerMain$subscriptions,
				view: function (_p4) {
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Json_Decode$andThen,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'css', _elm_lang$core$Json_Decode$string),
							function (css) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'js', _elm_lang$core$Json_Decode$string),
									function (js) {
										return _elm_lang$core$Json_Decode$succeed(
											{css: css, js: js});
									});
	...
	var Elm = {};
	Elm['ServerMain'] = Elm['ServerMain'] || {};
	_elm_lang$core$Native_Platform.addPublicModule(Elm['ServerMain'], 'ServerMain', typeof _greyepoxy$elm_gamehostserver$ServerMain$main === 'undefined' ? null : _greyepoxy$elm_gamehostserver$ServerMain$main);
